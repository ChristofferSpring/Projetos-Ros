...
"""autogenerated by genpy from vision_msgs/PersonArray.msg. Do not edit."""
import codecs
import sys
...
class PersonArray(genpy.Message):
  _md5sum = "872eed47d7ac1b33328ff3b99b4cbda3"
  _type = "vision_msgs/PersonArray"
...
bool do_rectify
"""
  __slots__ = ['header','image','cropped','roi']
  _slot_types = ['std_msgs/Header','sensor_msgs/Image','sensor_msgs/Image[]','sensor_msgs/RegionOfInterest[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.cropped)
      buff.write(_struct_I.pack(length))
      for val1 in self.cropped:
        _v1 = val1.header
        _x = _v1.seq
