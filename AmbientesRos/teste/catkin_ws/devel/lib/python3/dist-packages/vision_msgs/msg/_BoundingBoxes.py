...
"""autogenerated by genpy from vision_msgs/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  _md5sum = "e75120d5d9f821b0d5b71abf71af7855"
  _type = "vision_msgs/BoundingBoxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','vision_msgs/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = vision_msgs.msg.BoundingBox()
        _v3 = val1.header
        start = end
        end += 4
