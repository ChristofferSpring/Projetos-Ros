...
"""autogenerated by genpy from vision_msgs/BoundingBox.msg. Do not edit."""
import codecs
import sys
...
class BoundingBox(genpy.Message):
  _md5sum = "04d358955c3f00fffd65f2bf2e0dd481"
  _type = "vision_msgs/BoundingBox"
...
string frame_id
"""
  __slots__ = ['header','probability','xmin','ymin','xmax','ymax','id','Class']
  _slot_types = ['std_msgs/Header','float64','int64','int64','int64','int64','int16','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,probability,xmin,ymin,xmax,ymax,id,Class
